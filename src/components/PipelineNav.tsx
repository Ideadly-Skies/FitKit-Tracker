...
import { BR, LAV, LAV2, TX, TXL } from '../constants';

interface PipelineNavProps {
  activeStage: Stage | 0;
  onStageClick: (id: Stage) => void;
  stageCount: (s: Stage) => number;
}

export default function PipelineNav({ activeStage, onStageClick, stageCount }: PipelineNavProps) {
  return (
